...
import AnsvaligPersonerInputs, {
    IAnsvarligPerson,
} from '../../komponenter/lagSamtykkeskjema/AnsvarligPersonerInputs'
import JaNeiValg from '../../komponenter/lagSamtykkeskjema/JaNeiValg'
import KontaktPersonerInputs, {
    IKontaktPerson,
} from '../../komponenter/lagSamtykkeskjema/KontaktPersonerInputs'
    ...
    return (
        <div className="lag-samtykkeskjema">
            ...
            <Textarea
                ...
                onChange={(e) => {
                    settUndersøkelseOm(e.target.value)
                }}
            />
            <Textarea
            ...
            <Textarea
                ...
                value={skalBrukesTil}
                onChange={(e) => {
                    settSkalBrukesTil(e.target.value)
                }}
            />
            <VelgStartSluttDato
                startDato={startDato}
            ...
            />
            <p>
                Undersøkelsen vil bli publisert i en rapport. Rapporten skal deles med ansatte i NAV
                og med våre sammargeidspartnere utenfor NAV.
            </p>
            <h4>Hver er vi og hvem er ansvarlig for undersøkelsen?</h4>
            <p className="ansvarlig-person-input-tekst">
                Vi er ansatt i Designseksjonen i NAV IT i Arbieds- og velferdsdirektoratet (NAV). I
            ...
            />
            <p className="kontakt-person-input-tekst">
            ...
            />
            <p>
                I denne undersøkelsen gjør vi intervjuer. Vi ønsker også å ta opp intervjuet med
                lydopptaker, for lettere å kunne skrive ned det du sier.
            </p>
            <TittelMedHjelpetekst
            ...
            <Textarea
                ...
                value={spørreOm}
                onChange={(e) => {
                    settSpørreOm(e.target.value)
                }}
            />
            <p>
                Du velger selv om du vil fortelle om sensitive opplysninger som helseforhold eller
                hvor du jobber. Opplysningene vi samler inn skal kun brukes til det undersøkelsen
                handler om, og det du har samtykket til.
            </p>
            <TittelMedHjelpetekst
            ...
            />
            <span>
                Alle opplysningene om deg lagres i NAVs systemer. Det er bare ansatte som jobber med
                undersøkelsen som har tilgang. Vi sletter all personlig data om deg så snart vi ikke
                har bruk for det, senest
                <LagringsTidSelect
                    lagringsTid={lagringsTid}
            ...
            <div className="tittel-med-hjelpetekst">
                ...
                <Hjelpetekst className="taushetsplikt-hjelpetekst-popover">
                    ...
                    <p className="taushetsplikt-hjelpetekst">
                        ...
                        forskningsintutisjoner utenfor EU/EØS må det i tilleg informeres om risiko
                        og tiltak forbundet med dette.
                    </p>
                </Hjelpetekst>
            </div>
            <p>
            ...
            <p>
                Før opplysningene slettes så anynomiseres de slik at de kan formidles videre til
                andre. Opplysningene anonymiseres ved at alle inervjuer får en kode som viser kjønn
                og alder, mens alle opplysninger som kan lede tilbake til deg fjernes.
            </p>
            <h3>Dine rettigheter</h3>
            <p>
                Det er frivilig å delta. Du kan når som helt avslutte intervjuet, uten å måtte oppgi
                en grunn. Ønsker du å trekke samtykket ditt, så sørger vi for at alt materiale om
                deg slettes. Du har også rett til å se, rette eller slette dine opplysninger både
                under og etter at intervjuet er ferdig. Kontak:
                {/* TODO Legge inn kontaktperson info som blir fylt ut over*/}
                på epost så hjelper vi deg.
            </p>
            <p>
                Mottar du tjenester fra NAV, vil ikke deltakelse i denne undersøkelsen påvirke dine
                rettigheter i NAV. Vi har ikke tilgang i dine saker. Andre i NAV får heller ikke
                vite hvem som deltar i undersøkelsen, og opplysningene du gir kan ikke kobles til
                dine saker.
            </p>
            <h3>Jeg forstår:</h3>
