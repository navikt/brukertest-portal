            ...
            <div className="steg">
                <Stegindikator
                    steg={[
                        ...
                        { label: 'Deretter må du gjøre dette', index: 3 },
                        { label: 'Deretter må du gjøre dette', index: 4 },
                        { label: 'Deretter må du gjøre dette', index: 5 },
                        { label: 'Deretter må du gjøre dette', index: 6 },
